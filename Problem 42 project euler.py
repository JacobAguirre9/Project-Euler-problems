...
# For the words.txt file, please visit https://projecteuler.net/problem=42


# So, let's build a program that solves this question!

# First, we need to import the library "itertools". This will allow for us to obtain the count function

import itertools


def TriangleNumberComputation():
	answer = sum(1
		for s in WORDS
		if is_a_triangle_number(sum((ord(c) - ord('A') + 1) for c in s)))
	return str(answer)

# The code below is pretty self-explanatory, and so I will leave it to the reader to prove
def is_a_triangle_number(n):
	temp = 0
...
# Now, we must import all the words from the tex file given to us by Project Euler.
# This is given in the form of a dictionary
...
if __name__ == "__main__":
	print(TriangleNumberComputation())

# So, after running the code we find that there exists 162 words within this database that are triangle numbers

# I hope this code helps you! :D
